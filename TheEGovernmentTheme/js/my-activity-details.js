jQuery(document).ready(function () {
  jQuery(".ActivityDetails").on("click", function (e) {
    ...
    jQuery.ajax({
      ...
      dataType: "html",
      data: {
        serviceId: jQuery(this).attr("data-id"),
        serviceTypeId: jQuery(this).attr("data-type"),
      },
      type: "GET",
      ...
      success: function (response) {
        ...
        jQuery(".act-finance>li.open>.content").css("display", "block"),
          jQuery(".act-finance>li>.acl-head").click(function (a) {
